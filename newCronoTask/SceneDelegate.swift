...
//    UserDefaults.standard.set(0.0, forKey: "intervalo")
//     print("scene will resign active: \(date)")
  }
...
//      UserDefaults.standard.set(Date().timeIntervalSince(date), forKey: "intervalo")
//      print("Han pasado: \(Date().timeIntervalSince(date))")
//    }
  }
